          ...
          <Table className="min-w-[600px]">
            <TableHeader>
              <TableRow className="border-none hover:bg-transparent">
                ...
                <TableHead className="text-muted-foreground font-medium h-10 px-4 text-right">Volume</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {rows.map((row) => (
                <TableRow key={row.symbol} className="border-none group hover:bg-muted/40 transition-colors">
                  ...
                  <TableCell className="text-right text-muted-foreground tabular-nums px-4 whitespace-nowrap uppercase text-xs">
                    {row.volume}
                  </TableCell>
                </TableRow>
              ))}
