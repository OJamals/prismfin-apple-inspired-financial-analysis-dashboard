            ...
            <Table className="min-w-[600px]">
              ...
              <TableBody>
                {rows.map((row, idx) => {
                  ...
                  // Append index to symbol for unique gradient IDs even if symbols collide
                                  ...
                                  <div className="space-y-5">
                                    ...
                                    <div className="space-y-4">
                                      <div className="flex justify-between items-end">
                                        <span className="text-4xl font-bold font-display tabular-nums tracking-tighter">{safeSentiment}%</span>
                                        <span className={cn(
                                          "text-[10px] font-bold px-3 py-1 rounded-full uppercase shadow-sm border border-white/60",
                                          safeSentiment > 70 ? "bg-gain-50 text-gain-700" :
                                          safeSentiment < 30 ? "bg-loss-50 text-loss-700" : "bg-white text-muted-foreground"
                                        )}>
                                      ...
                                      <div className="relative h-2 w-full bg-secondary/50 shadow-inner rounded-full overflow-hidden">
                                        <div
                                          className={cn(
                                            ...
                                            safeSentiment > 70 ? "bg-gain-500" : safeSentiment < 30 ? "bg-loss-500" : "bg-brand-blue"
                                          )}
